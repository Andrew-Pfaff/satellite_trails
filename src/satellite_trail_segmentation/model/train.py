...
def main(epochs, batch_size, learning_rate, dropout_rate, lr_decay, save_path=None):
    train_ds = H5PatchDataset("data/patches.h5", split="train")
    val_ds = H5PatchDataset("data/patches.h5", split="val")
...
if __name__ == "__main__":
    ...
    train_loss, val_loss = main(epochs=args.epochs,
