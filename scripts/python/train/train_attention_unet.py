...
def main(data_path, epochs, batch_size, learning_rate, dropout_rate,
         ...
         p_shift=0.0, min_shift=15, max_shift=100):
    ...
    train_metrics = train_unet(model, train_ds, val_ds, optimizer, scheduler,
                               ...
                               trial=None, seed=seed, iou_thresholds=THRESHOLDS,
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train Attention U-Net satellite trail segmentation model")
    ...
    parser.add_argument("--bce-weight-factor", type=float, default=0.5)
    ...
    parser.add_argument("--no-batchnorm", dest="use_batchnorm", action="store_false", default=True)
...
if __name__ == "__main__":
    ...
    train_loss, val_loss = main(data_path=args.data_path,
                                ...
                                bce_weight_factor=args.bce_weight_factor,
