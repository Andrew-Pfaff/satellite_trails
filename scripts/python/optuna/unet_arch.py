...
def create_objective(data_path, epochs, batch_size, num_workers, seed):
    ...
    def objective(trial):
        ...
        sampler_fraction = trial.suggest_float("sampler_fraction", 0.05, 0.9)
...
if __name__ == "__main__":
    ...
    study = optuna.create_study(study_name="unet_arch_tuning", storage=f"sqlite:///{db_file_dir}/unet_arch_tuning.db", 
                                load_if_exists=True, 
                                direction="maximize", 
